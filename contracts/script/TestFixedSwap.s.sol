...
contract TestFixedSwap is Script {
    ...
    function run() external {
        ...
        console.log("Revealing and swapping...");
        ...
        // FIX: Use a valid sqrtPriceLimitX96 that's slightly above MIN for zeroForOne=true
        // MIN_SQRT_PRICE = 4295128739, so we use something reasonable like MIN + 1000
        // Or just use a higher value that still allows the swap to go through
        SwapParams memory params = SwapParams({
            zeroForOne: true,
            amountSpecified: int256(amount),
            sqrtPriceLimitX96: 4295128739 + 100000  // Much higher than MIN but still valid
        });
