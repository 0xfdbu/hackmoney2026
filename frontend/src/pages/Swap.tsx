...
const rate = fromToken === 'ETH' || fromToken === 'WETH' ? 2249.85 : 0.000445;
...
currency0,
currency1,
fee: 500, // Changed from 3000 to 500 (0.05% = 500 basis points)
tickSpacing: 10, // 0.05% pools use tickSpacing of 10, not 60
hooks: HOOK_ADDRESS,
};
